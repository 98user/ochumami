...
export default function DrinkScreen() {
  ...
  if (!context) throw new Error('DrinkScreen must be used within a SakeProvider');
  const { sakeList, deleteSake } = context;
      ...
      {sakeList.map((item) => (
        <View style={styles.card} key={item.id}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('EditSake', { sake: item })}
          >
