...
export default function BeerScreen() {
  ...
  if (!context) throw new Error('BeerScreen must be used within a BeerProvider');
  const { beerList, deleteBeer } = context;
      ...
      {beerList.map((item) => (
        <View style={styles.card} key={item.id}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('EditBeer', { beer: item })}
          >
